...
/**
 * Class MIcsWorks
 * Representation for db table ics_works.
 ...
 * @property  DAssuranceMapIcsWork[] relsAssuranceMapIcsWorkByIcsWork                                   
...
class MIcsWorks extends DBClass {
	...
	const  FR_ASSURANCE_MAP_ICS_WORK_BY_ICSWORK = 'relsAssuranceMapIcsWorkByIcsWork';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAssuranceMapIcsWorkByIcsWork(){
            return $this->hasMany(DAssuranceMapIcsWork::class, DAssuranceMapIcsWork::F_ICSWORK, self::F_ID);
        }
