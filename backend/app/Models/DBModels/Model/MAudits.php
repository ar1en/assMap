...
/**
 * Class MAudits
 * Representation for db table audits.
 ...
 * @property  DAuditIssue[]   relsAuditIssueByAudit                                       
 * @property  DAuditObject[]  relsAuditObjectByAudit                                      
 * @property  DAuditProcess[] relsAuditProcessByAudit                                     
...
class MAudits extends DBClass {
	...
	const  FR_AUDIT_ISSUE_BY_AUDIT   = 'relsAuditIssueByAudit';
	const  FR_AUDIT_OBJECT_BY_AUDIT  = 'relsAuditObjectByAudit';
	const  FR_AUDIT_PROCESS_BY_AUDIT = 'relsAuditProcessByAudit';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAuditIssueByAudit(){
            return $this->hasMany(DAuditIssue::class, DAuditIssue::F_AUDIT, self::F_ID);
        }
         ...
         */
        public function relsAuditObjectByAudit(){
            return $this->hasMany(DAuditObject::class, DAuditObject::F_AUDIT, self::F_ID);
        }
         ...
         */
        public function relsAuditProcessByAudit(){
            return $this->hasMany(DAuditProcess::class, DAuditProcess::F_AUDIT, self::F_ID);
        }
