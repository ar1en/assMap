...
/**
 * Class MVacancies
 * Representation for db table vacancies.
 ...
 * @property  DUserVacancy[]  relsUserVacancyByVacancy                                      
...
class MVacancies extends DBClass {
	...
	const  FR_USER_VACANCY_BY_VACANCY = 'relsUserVacancyByVacancy';
	...
	public static array $jsonable = [
		...
		MVacancies::FJ_NAME       =>[ MVacancies::F_NAME       ,null,'string',           ],
         ...
         */
        public function relsUserVacancyByVacancy(){
            return $this->hasMany(DUserVacancy::class, DUserVacancy::F_VACANCY, self::F_ID);
        }
