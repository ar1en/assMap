...
/**
 * Class MProcesses
 * Representation for db table processes.
 ...
 * @property  DAssuranceMapProcess[]        relsAssuranceMapProcessByProcess                                             
 * @property  DAuditProcess[]               relsAuditProcessByProcess                                                    
 * @property  DAutomatedMonitoringProcess[] relsAutomatedMonitoringProcessByProcess                                      
 * @property  DCollegiateBodyProcess[]      relsCollegiateBodyProcessByProcess                                           
 * @property  DDepartmentProcess[]          relsDepartmentProcessByProcess                                               
 * @property  DDocumentProcesses[]          relsDocumentProcessesByProcess                                               
 * @property  DExternalInspectionProcess[]  relsExternalInspectionProcessByProcess                                       
 * @property  DIcsMatrices[]                relsIcsMatricesByProcess                                                     
 * @property  DIcsWorks[]                   relsIcsWorksByProcess                                                        
 * @property  DInternalInspectionProcess[]  relsInternalInspectionProcessByProcess                                       
 * @property  DIssueProcess[]               relsIssueProcessByProcess                                                    
 * @property  DProcesses[]                  relsProcessesByParentProcess                                                 
 * @property  DRiskProcesses[]              relsRiskProcessesByProcess                                                   
 * @property  DRiskRates[]                  relsRiskRatesByProcess                                                       
...
class MProcesses extends DBClass {
	...
	const  FR_ASSURANCE_MAP_PROCESS_BY_PROCESS        = 'relsAssuranceMapProcessByProcess';
	const  FR_AUDIT_PROCESS_BY_PROCESS                = 'relsAuditProcessByProcess';
	const  FR_AUTHOR                                  = 'relAuthor';
	const  FR_AUTOMATED_MONITORING_PROCESS_BY_PROCESS = 'relsAutomatedMonitoringProcessByProcess';
	const  FR_COLLEGIATE_BODY_PROCESS_BY_PROCESS      = 'relsCollegiateBodyProcessByProcess';
	const  FR_DEPARTMENT_PROCESS_BY_PROCESS           = 'relsDepartmentProcessByProcess';
	const  FR_DOCUMENT_PROCESSES_BY_PROCESS           = 'relsDocumentProcessesByProcess';
	const  FR_EXTERNAL_INSPECTION_PROCESS_BY_PROCESS  = 'relsExternalInspectionProcessByProcess';
	const  FR_ICS_MATRICES_BY_PROCESS                 = 'relsIcsMatricesByProcess';
	const  FR_ICS_WORKS_BY_PROCESS                    = 'relsIcsWorksByProcess';
	const  FR_INTERNAL_INSPECTION_PROCESS_BY_PROCESS  = 'relsInternalInspectionProcessByProcess';
	const  FR_ISSUE_PROCESS_BY_PROCESS                = 'relsIssueProcessByProcess';
	...
	const  FR_RISK_PROCESSES_BY_PROCESS               = 'relsRiskProcessesByProcess';
	const  FR_RISK_RATES_BY_PROCESS                   = 'relsRiskRatesByProcess';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAssuranceMapProcessByProcess(){
            return $this->hasMany(DAssuranceMapProcess::class, DAssuranceMapProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsAuditProcessByProcess(){
            return $this->hasMany(DAuditProcess::class, DAuditProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsAutomatedMonitoringProcessByProcess(){
            return $this->hasMany(DAutomatedMonitoringProcess::class, DAutomatedMonitoringProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsCollegiateBodyProcessByProcess(){
            return $this->hasMany(DCollegiateBodyProcess::class, DCollegiateBodyProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsDepartmentProcessByProcess(){
            return $this->hasMany(DDepartmentProcess::class, DDepartmentProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsDocumentProcessesByProcess(){
            return $this->hasMany(DDocumentProcesses::class, DDocumentProcesses::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsExternalInspectionProcessByProcess(){
            return $this->hasMany(DExternalInspectionProcess::class, DExternalInspectionProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsInternalInspectionProcessByProcess(){
            return $this->hasMany(DInternalInspectionProcess::class, DInternalInspectionProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsIssueProcessByProcess(){
            return $this->hasMany(DIssueProcess::class, DIssueProcess::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsRiskProcessesByProcess(){
            return $this->hasMany(DRiskProcesses::class, DRiskProcesses::F_PROCESS, self::F_ID);
        }
         ...
         */
        public function relsRiskRatesByProcess(){
            return $this->hasMany(DRiskRates::class, DRiskRates::F_PROCESS, self::F_ID);
        }
