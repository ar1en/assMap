...
/**
 * Class MFines
 * Representation for db table fines.
 ...
 * @property  DExternalInspectionFine[] relsExternalInspectionFineByFine                                  
...
class MFines extends DBClass {
	...
	const  FR_EXTERNAL_INSPECTION_FINE_BY_FINE = 'relsExternalInspectionFineByFine';
	...
	public static array $jsonable = [
         ...
         */
        public function relsExternalInspectionFineByFine(){
            return $this->hasMany(DExternalInspectionFine::class, DExternalInspectionFine::F_FINE, self::F_ID);
        }
