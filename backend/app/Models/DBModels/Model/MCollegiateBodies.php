 ...
 * Representation for db table collegiate_bodies.
 ...
 * @property  DAssuranceMapCollegiateBody[] relsAssuranceMapCollegiateBodyByCollegiateBody                                  
 * @property  DCollegiateBodyDocument[]     relsCollegiateBodyDocumentByCollegiateBody                                      
 * @property  DCollegiateBodyProcess[]      relsCollegiateBodyProcessByCollegiateBody                                       
...
class MCollegiateBodies extends DBClass {
	...
	const  FR_ASSURANCE_MAP_COLLEGIATE_BODY_BY_COLLEGIATEBODY = 'relsAssuranceMapCollegiateBodyByCollegiateBody';
	const  FR_AUTHOR                                          = 'relAuthor';
	const  FR_COLLEGIATE_BODY_DOCUMENT_BY_COLLEGIATEBODY      = 'relsCollegiateBodyDocumentByCollegiateBody';
	const  FR_COLLEGIATE_BODY_PROCESS_BY_COLLEGIATEBODY       = 'relsCollegiateBodyProcessByCollegiateBody';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAssuranceMapCollegiateBodyByCollegiateBody(){
            return $this->hasMany(DAssuranceMapCollegiateBody::class, DAssuranceMapCollegiateBody::F_COLLEGIATEBODY, self::F_ID);
        }
         ...
         */
        public function relsCollegiateBodyDocumentByCollegiateBody(){
            return $this->hasMany(DCollegiateBodyDocument::class, DCollegiateBodyDocument::F_COLLEGIATEBODY, self::F_ID);
        }
         ...
         */
        public function relsCollegiateBodyProcessByCollegiateBody(){
            return $this->hasMany(DCollegiateBodyProcess::class, DCollegiateBodyProcess::F_COLLEGIATEBODY, self::F_ID);
        }
