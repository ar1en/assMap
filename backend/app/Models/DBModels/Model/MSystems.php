...
/**
 * Class MSystems
 * Representation for db table systems.
 ...
 * @property  DAutomatedMonitoringSystem[] relsAutomatedMonitoringSystemBySystem                                  
...
class MSystems extends DBClass {
	...
	const  FR_AUTOMATED_MONITORING_SYSTEM_BY_SYSTEM = 'relsAutomatedMonitoringSystemBySystem';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAutomatedMonitoringSystemBySystem(){
            return $this->hasMany(DAutomatedMonitoringSystem::class, DAutomatedMonitoringSystem::F_SYSTEM, self::F_ID);
        }
