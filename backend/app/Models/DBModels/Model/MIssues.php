...
/**
 * Class MIssues
 * Representation for db table issues.
 ...
 * @property  DAssuranceMapIssue[] relsAssuranceMapIssueByIssue                                     
 * @property  DAuditIssue[]        relsAuditIssueByIssue                                            
 * @property  DIssueProcess[]      relsIssueProcessByIssue                                          
...
class MIssues extends DBClass {
	...
	const  FR_ASSURANCE_MAP_ISSUE_BY_ISSUE = 'relsAssuranceMapIssueByIssue';
	const  FR_AUDIT_ISSUE_BY_ISSUE         = 'relsAuditIssueByIssue';
	const  FR_AUTHOR                       = 'relAuthor';
	const  FR_ISSUE_PROCESS_BY_ISSUE       = 'relsIssueProcessByIssue';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAssuranceMapIssueByIssue(){
            return $this->hasMany(DAssuranceMapIssue::class, DAssuranceMapIssue::F_ISSUE, self::F_ID);
        }
         ...
         */
        public function relsAuditIssueByIssue(){
            return $this->hasMany(DAuditIssue::class, DAuditIssue::F_ISSUE, self::F_ID);
        }
         ...
         */
        public function relsIssueProcessByIssue(){
            return $this->hasMany(DIssueProcess::class, DIssueProcess::F_ISSUE, self::F_ID);
        }
