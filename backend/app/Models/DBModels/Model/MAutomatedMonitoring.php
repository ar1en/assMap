 ...
 * Representation for db table automated_monitoring.
 ...
 * @property  DAssuranceMapAutomatedMonitoring[] relsAssuranceMapAutomatedMonitoringByAutomatedMonitoring                                  
 * @property  DAutomatedMonitoringProcess[]      relsAutomatedMonitoringProcessByAutomatedMonitoring                                       
 * @property  DAutomatedMonitoringSystem[]       relsAutomatedMonitoringSystemByAutomatedMonitoring                                        
...
class MAutomatedMonitoring extends DBClass {
	...
	const  FR_ASSURANCE_MAP_AUTOMATED_MONITORING_BY_AUTOMATEDMONITORING = 'relsAssuranceMapAutomatedMonitoringByAutomatedMonitoring';
	const  FR_AUTHOR                                                    = 'relAuthor';
	const  FR_AUTOMATED_MONITORING_PROCESS_BY_AUTOMATEDMONITORING       = 'relsAutomatedMonitoringProcessByAutomatedMonitoring';
	const  FR_AUTOMATED_MONITORING_SYSTEM_BY_AUTOMATEDMONITORING        = 'relsAutomatedMonitoringSystemByAutomatedMonitoring';
	...
	public static array $jsonable = [
         ...
         */
        public function relsAssuranceMapAutomatedMonitoringByAutomatedMonitoring(){
            return $this->hasMany(DAssuranceMapAutomatedMonitoring::class, DAssuranceMapAutomatedMonitoring::F_AUTOMATEDMONITORING, self::F_ID);
        }
         ...
         */
        public function relsAutomatedMonitoringProcessByAutomatedMonitoring(){
            return $this->hasMany(DAutomatedMonitoringProcess::class, DAutomatedMonitoringProcess::F_AUTOMATEDMONITORING, self::F_ID);
        }
         ...
         */
        public function relsAutomatedMonitoringSystemByAutomatedMonitoring(){
            return $this->hasMany(DAutomatedMonitoringSystem::class, DAutomatedMonitoringSystem::F_AUTOMATEDMONITORING, self::F_ID);
        }
